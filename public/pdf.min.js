...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  return /******/ (() => {
    ...
    /******/ var __webpack_modules__ = [
      ...
      /***/ (__unused_webpack_module, exports, __w_pdfjs_require__) => {
        ...
        class BaseFontLoader {
          ...
          insertRule(rule) {
            ...
            if (!styleElement) {
              styleElement = this.styleElement = this._document.createElement(
                'style',
              );
        ...
        class TilingPattern {
          ...
          clipBbox(graphics, x0, y0, x1, y1) {
            ...
            graphics.current.updateRectMinMax(
              graphics.ctx.mozCurrentTransform,
              [x0, y0, x1, y1],
            );
            graphics.clip();
            graphics.endPath();
        ...
        class AnnotationElement {
          ...
          _createContainer(ignoreBorder = false) {
            ...
            if (data.hasOwnCanvas) {
              ...
              const [scaleX, scaleY] = _util.Util.singularValueDecompose2dScale(
                transform,
              );
              ...
              if (this.enableScripting && this.hasJSActions) {
                ...
                element.addEventListener('blur', (event) => {
                  ...
                  if (
                    ...
                    elementData.valueOnFocus !== value
                  ) {
                    this.linkService.eventBus?.dispatch(
                      'dispatcheventinsandbox',
                      {
      ...
      /***/ (__unused_webpack_module, exports, __w_pdfjs_require__) => {
        ...
        function getAscent(fontFamily, ctx) {
          ...
          pixels = ctx.getImageData(0, 0, DEFAULT_FONT_SIZE, DEFAULT_FONT_SIZE)
            .data;
          ascent = 0;
        ...
        exports.SVGGraphics = SVGGraphics;
        {
          ...
          exports.SVGGraphics = SVGGraphics = class {
            ...
            _makeTilingPattern(args) {
              ...
              const [xscale, yscale] = _util.Util.singularValueDecompose2dScale(
                matrix,
              );
                ...
                case 'RadialAxial':
                  ...
                  switch (args[1]) {
                    case 'axial':
                      const point0 = args[4];
                      const point1 = args[5];
                      gradient = this.svgFactory.createElement(
                        'svg:linearGradient',
                      );
      ...
      /***/ (__unused_webpack_module, exports, __w_pdfjs_require__) => {
        ...
        class PDFNetworkStreamFullRequestReader {
          ...
          _onHeadersReceived() {
            ...
            const fullRequestXhr = this._manager.getRequestXhr(
              fullRequestXhrId,
            );
    ...
    (() => {
      ...
      {
        if (_is_node.isNodeJS) {
          const { PDFNodeStream } = __w_pdfjs_require__(25);

          (0, _api.setPDFNetworkStreamFactory)((params) => {
            return new PDFNodeStream(params);
          });
        } else {
          const { PDFNetworkStream } = __w_pdfjs_require__(28);

          const { PDFFetchStream } = __w_pdfjs_require__(29);
